...
//                     {users && users.student.map((student,index) => <tr class="bg-white border-b hover:bg-gray-50">
...
//                         </th>
//                         <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
//                             { student.Emailverified ? <label className="bg-sky-400 px-2 py-0.5 rounded-full text-xs text-white">verified</label>:<label className="bg-red-400 px-2 py-0.5 rounded-full text-xs text-white">not verified</label>}
//                         </th>
//                         <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
//                             {student.password}
//                         </th>
...
//                     {users.teacher.map((teacher,index) => <tr class="bg-white border-b hover:bg-gray-50" >
//                         <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
//                         {index+1}
//                         </th>
//                         <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
...
//                         </th>
//                         <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
//                             { teacher.Emailverified ? <label className="bg-sky-400 px-2 py-0.5 rounded-full text-xs text-white">verified</label>:<label className="bg-red-400 px-2 py-0.5 rounded-full text-xs text-white">not verified</label>}
//                         </th>
//                         <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
//                             {teacher.password}
//                         </th>
...
//         </div>
//     </div>
//     {editUserId !== -1 && <div className="z-10 absolute w-screen h-screen bg-black bg-opacity-75 top-0 left-1/2 transform -translate-x-1/2 flex justify-center items-center">
//         {console.log(editUserData)}
