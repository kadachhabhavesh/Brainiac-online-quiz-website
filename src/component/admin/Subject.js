...
export default () => {
    ...
    return <div className="w-full my-4">
        ...
        <div className=" w-full h-[88vh] mt-2 flex flex-col gap-y-2 overflow-y-scroll no-scrollbar">
            ...
            {subjects && subjects.length > 0 && subjects.map((subject, index) => <div>
                <div className="w-1/2 h-10 bg-white rounded flex items-center justify-between p-4 hover:shadow-lg">
                ...
                <div className="flex gap-x-2">
                    <svg className="h-6 hover:bg-gray-300 rounded p-1 stroke-red-500 fill-red-500" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 30 30" onClick={() => deleteSubject(subject._id)}>
                        <path d="M 14.984375 2.4863281 A 1.0001 1.0001 0 0 0 14 3.5 L 14 4 L 8.5 4 A 1.0001 1.0001 0 0 0 7.4863281 5 L 6 5 A 1.0001 1.0001 0 1 0 6 7 L 24 7 A 1.0001 1.0001 0 1 0 24 5 L 22.513672 5 A 1.0001 1.0001 0 0 0 21.5 4 L 16 4 L 16 3.5 A 1.0001 1.0001 0 0 0 14.984375 2.4863281 z M 6 9 L 7.7929688 24.234375 C 7.9109687 25.241375 8.7633438 26 9.7773438 26 L 20.222656 26 C 21.236656 26 22.088031 25.241375 22.207031 24.234375 L 24 9 L 6 9 z"></path>
                    </svg>
                    {EditSubId !== subject._id && <svg className="h-6 hover:bg-gray-300 rounded p-1 stroke-teal-900 fill-teal-900" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 24 24" onClick={() => setEditSubId(subject._id)}>
                    ...
                    <svg className="bi bi-caret-down-fill h-6 hover:bg-gray-300 rounded p-1 stroke-black-500 fill-black-500" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16">
