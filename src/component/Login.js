    ...
    const handleFormSubmition = (e) => {
        ...
        fetch('http://localhost:4000/user/login', {
            ...
            if (!res.incorrect) {
                ...
                if(!res.emailverified || res.emailverified)
                    setErrorMsg({ "msg": res.msg, ["iserr"]: true })
                else{
                    setErrorMsg({ "msg": "<a href='/OTPConfirm/"+res.userId+"'>Click here to verify your email</a>", ["iserr"]: true })
                }
            }
        ...
        <div className="h-screen bg-gray-200 flex items-center">
            {errorMsg.msg && (
                <div className="absolute top-2 flex justify-center items-center w-full">
                    ...
                    >
                        <div className="font-bold" dangerouslySetInnerHTML={{ __html: errorMsg.msg }}></div>
                        <svg
                    ...
                    <form>
                        ...
                        <div className="flex flex-col items-center mt-5">
                            ...
                            <Link
                                ...
                                to="/signup"
                            >
                                <span className="text-black">Don't have an account? </span>Create Account
                            </Link>
                        </div>
                    </form>
                </div>
