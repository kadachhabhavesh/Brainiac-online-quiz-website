...
export default function PlayQuiz() {
  ...
  useEffect(() => {
    fetch(`http://localhost:4000/quiz/${quizid}`, {
      ...
      .then((res) => {
        ...
        // res.questions = shuffleArray(res.questions).map((question) => {
        //   return {
        //     ...question,
  ...
  return quizData && (
    <div className="_main w-full bg-slate-200 p-5 flex gap-x-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <button
                          ...
                          onClick={() => navigator.clipboard.writeText(quizData.code)}
                        >
